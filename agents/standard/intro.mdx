...
See [Process Overview](../process/overview) and [Using MeshAgent Process](../process/using_process) for the recommended workflow.
...
- [Process Overview](../process/overview): Learn when to use the recommended multi-channel agent path.
- [Using MeshAgent Process](../process/using_process): Start with the practical `meshagent process` workflow.
