...
Both can be used for project services or room services. The difference is whether configuration is fixed or provided at runtime. For full details, see [Packaging and Deploying Services](./packaging).
...
- [Packaging and deploying services](./packaging) when you’re ready to deploy across every room.
