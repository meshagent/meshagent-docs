...
The [`environment`](./service_manifest_reference#container-environment) section injects a `MESHAGENT_TOKEN` with the API scopes this service needs for messaging, storage, queue handling, and agent/tool registration.
