...
- **Option 1 (`meshagent worker deploy`):** One command that deploys immediately - fastest approach
- **Option 2 (`meshagent worker spec` + `meshagent service create`):** Generates a yaml file you can version control, review, or customize before deploying
