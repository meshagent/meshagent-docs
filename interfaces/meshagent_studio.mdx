...
## Next Steps
- Follow the [Getting Started guide](../introduction/get_started) to create your first project and room.
- Use the [CLI Quickstart](../introduction/cli_quickstart) to complement what you configure in MeshAgent Studio.
