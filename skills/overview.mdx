...
MeshAgent agents including [ChatBot](../agents/standard/chatbot), [Worker](../agents/standard/worker), [TaskRunner](../agents/standard/taskrunner), and [MailBot](../agents/standard/mailbot) support this pattern. If a MeshAgent CLI runtime exposes `--skill-dir`, the same mental model applies: skills provide reusable guidance, while tools provide the executable capabilities.
...
- [Using Skills with Agents](./using_with_agents): load skills into ChatBots, Workers, TaskRunners, and MailBots.
