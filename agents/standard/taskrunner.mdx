...
Once you call the agent into a room, your TaskRunner becomes an invokable participant. You can discover and run it directly from the [MeshAgent Studio](https://studio.meshagent.com) via the "Run Task..." menu option, from the CLI ``meshagent agents ask``, or programatically via ``room.agents.ask(...)`` in your code. 
