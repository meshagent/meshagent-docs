---
title: "Use an Existing Agent (Archived SDK Pattern)"
---

import PydanticAgents from "/snippets/examples/archive/python/agents/taskrunner/pydanticai_translator/pydanticai_translator_taskrunner.mdx"
import InvokingTaskRunner from "/snippets/examples/archive/python/agents/taskrunner/pydanticai_translator/invoking_taskrunner.mdx"
import PydanticTranslatorDockerfile from "/snippets/examples/archive/python/agents/taskrunner/pydanticai_translator/Dockerfile.mdx"
import PydanticTranslatorYaml from "/snippets/examples/archive/python/agents/taskrunner/pydanticai_translator/meshagent.mdx"

> **Archived:** This page documents an older SDK pattern based on `TaskRunner`. For new text and background agents, start with [`meshagent process`](../process/overview). This page remains as historical reference.
...
> **Note**: If you build your own image, we recommend optimizing it with [eStargz](../../services/containers/optimizing_containers) for faster pulls.
...
## Next Steps
- [Archived TaskRunner Overview](../archive/taskrunner): Understand the older TaskRunner CLI/runtime path
