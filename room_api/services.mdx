...
This page is about runtime control inside an active room. If you want to deploy, update, validate, or delete saved services, use [Deploy Services with MeshAgent](../services/deployment/deploy_services) and the project-level `meshagent service` command instead.
...
For the broader deployment permission model, see [API Scopes](../rest_api/api_scopes), [Participant Tokens](../rest_api/participant_tokens), and [Deploy Services with MeshAgent](../services/deployment/deploy_services).
