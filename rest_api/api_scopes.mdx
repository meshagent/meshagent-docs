...
- `ApiScope.agent_default()` – enables Livekit, Queues, Messaging, Dataset, Memory, Sync, Storage, Containers, Developer, Agents, LLM, Services, and Secrets access. Use `ApiScope.agent_default(tunnels=True)` to include the tunnels grant.
