...
Use this API to manage your account/projects and provision resources, manage access, configure services, inspect activity, and integrate MeshAgent into external systems. For room-specific operations such as working with agents, databases, or queues use the [Room APIs](../room_api/overview).

This page is organized by resource:
...
- **Integrations** – webhooks, API keys, OAuth clients
- **Shares** - create share links for Rooms
- **Mailboxes** - manage mailboxes mapped to Rooms
- **Operations** – sessions (events/spans/metrics) and scheduled tasks  
- **Billing & usage** – balance, transactions, subscriptions, usage reporting
