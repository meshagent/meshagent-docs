...
# Counters
calls = meter.create_counter("weather.calls", unit="1", description="Total weather tool invocations")
errors = meter.create_counter("weather.errors", unit="1", description="Errors during execution")
    ...
    async def execute(self, context: ToolContext, *, city: str, units:str):
        ...
        with tracer.start_as_current_span("fetch_weather_api") as span:
            ...
            try:
                ...
                errors.add(1, attributes={"kind": type(e).__name__, "city": city.lower()})
