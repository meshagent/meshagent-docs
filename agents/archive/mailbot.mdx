...
MailBots can be extended with rules, tools, and skills depending on the workflow they need to handle. See [Tools Overview](../tools/intro) and [Skills Overview](../../skills/overview).
...
For full details on the service spec and deployment flow, see [Packaging and Deploying Services](../../services_room_containers/packaging_and_deploying/packaging). If you want to deploy MailBot skills with the service, see [Packaging and Deploying Skills](../../skills/packaging_and_deploying).
...
| `skill_dirs`         | `list[str] \| None`           | Directories containing agent skills; added to the rules so the model can discover and use them. See [Skills Overview](../../skills/overview). |
...
- **Skills integration:** `skill_dirs` append skill descriptions to rules for tool execution guidance. See [Using Skills with Agents](../../skills/using_with_agents).
...
- [Skills Overview](../../skills/overview): Learn when MailBots should use skills
