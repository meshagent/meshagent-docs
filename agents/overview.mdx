...
- Go to [Tools](./tools/intro) and [Skills](../agent_skills/overview) to understand what agents can do and how you shape their behavior.
- Go to [Queues and Scheduled Tasks](./queues_and_scheduled_tasks) for recurring and background work patterns.
- Go to [Deploy & Manage](../deploy_manage/overview) when you are ready to package and deploy agents as services.
