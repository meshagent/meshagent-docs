...
## Getting Started
*Note: These steps are identical to the [Build and Deploy a ChatBot](buildanddeploychatbot.mdx) steps. Feel free to skip if you are already setup.*
...
This is the same process described in the [Build and Deploy a ChatBot Example](buildanddeploychatbot.mdx).
