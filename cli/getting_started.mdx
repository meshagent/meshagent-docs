...
When deploying a custom agent, you will need to build and push a docker image. For an example of this, checkout the [Deploying a ChatBot as a Project Service](../services_room_containers/project_services/project_service_example) guide where you'll learn how to build and deploy a chat agent as a project wide service.
