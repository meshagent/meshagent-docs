---
title: Deploy and Run Room Services
---
...
See the [room service configuartion]() docs for more details on creating the ``ServiceTemplate`` manifest and Dockerfile for your service.
...
## Next Steps
-  For a complete sample of running a room container check out the [room containers example](). In this example we'll run a simple chatbot with a user provided system prompt inside a specific room. 
...
- Check out [project services]() if the service should auto-start in all rooms.
