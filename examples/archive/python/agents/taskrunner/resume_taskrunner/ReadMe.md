...
`meshagent room agent invoke-tool --room=resume --toolkit=meshagent.runner --tool=run_meshagent.runner_task --arguments '{"prompt":"Do we have any applications from Parsa","model":"gpt-5.2","tools":[{"name":"database", "tables":["candidates"], "read_only": false}]}'`
