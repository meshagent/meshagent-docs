...
| [Project Service](../../services_room_containers/packaging)     | Deploy once to run automatically in every room of a project (admin only).  | Always-on shared agents            |
| [Room Service](../../services_room_containers/packaging)        | Deploy to a single Room only. Other Rooms in the Project won't see it.  | Agents that should stay room-scoped. |
