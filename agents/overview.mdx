...
- Go to [LLM Proxy](./routing/llm_proxy), [Using CLI Coding Agents with the MeshAgent LLM Proxy](./routing/cli_agents), and [LLM Adapters](./adapters/index) when you want MeshAgent to sit between agents or coding CLIs and the upstream model provider.
