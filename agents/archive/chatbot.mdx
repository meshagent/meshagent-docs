...
For full details on the service spec and deployment flow, see [Service YAML](../../services/deployment/deploy_services). If you want to ship reusable private skills with the chatbot, see [Bundle Private Skills with a Custom Service](../../agent_skills/packaging_and_deploying).
...
- [Service YAML](../../services/deployment/deploy_services): write service manifests for agents.
