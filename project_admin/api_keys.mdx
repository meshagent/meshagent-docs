...
API keys are project-scoped credentials used by services, CI pipelines, and backend systems to call MeshAgent APIs. If you plan to automate provisioning with the [REST API](../rest_api/overview), start by creating a key in [MeshAgent Studio](../interfaces/meshagent_studio) or the [MeshAgent CLI](../cli/cli_quickstart).
