...
For more details on the ``Service`` manifest, see the [project service configuration](./configuration) docs. Don't forget to add a "pull_secret" parameter to the manifest if you are pulling from a private repository. 
...
## Related topics
- [Project Service Configuration](./configuration): Understand the Meshagent ``Service`` manifest format for deploying project services. 
