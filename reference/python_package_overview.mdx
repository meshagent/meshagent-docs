...
| `meshagent-telegram` | `meshagent.telegram` | You want a command-hosted channel that connects a MeshAgent agent to Telegram |
| `meshagent-slack-channel` | `meshagent.slack_channel` | You want a command-hosted channel that connects a MeshAgent agent to Slack Events API |
| `meshagent-twilio` | `meshagent.twilio` | You want a command-hosted channel that connects a MeshAgent agent to Twilio SMS/MMS |
| `meshagent-whatsapp` | `meshagent.whatsapp` | You want a command-hosted channel that connects a MeshAgent agent to WhatsApp Cloud API text/media |
