    ...
    files:
      - path: /rules/email.txt
        text: |
          ...
          #Email reply rules
            You MUST reply with plain text or markdown, do not reply in JSON format or HTML format. Include the origial email content at the top of your response with nice and professional formatting, clearly delineated from your response. 
