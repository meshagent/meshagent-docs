---
title: "Using Multi-channel Agents (`meshagent process`)"
---
...
For a full packaging example, see [Deploy a Multi-channel Agent](../../services_room_containers/packaging_and_deploying/process_agent_service).
...
- [Multi-channel Agents Overview](./overview): what `meshagent process` is and the benefits it brings
- [Multi-channel Agent Architecture](./architecture): how channels, supervisors, and thread processes fit together under the hood
