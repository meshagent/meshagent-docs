...
Connect to a room and run a local command with MESHAGENT_API_URL, MESHAGENT_TOKEN, OPENAI_API_KEY, ANTHROPIC_API_KEY, and MESHAGENT_ROOM set. Use -- before the local command.
