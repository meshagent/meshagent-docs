...
- Inspect files, messages, databases, memory, images, registry tags, containers, services, and terminals inside a room.
...
- **Developer Console (bottom)**: Live debugging tabs for **Logs**, **Traces**, **Metrics**, **Images**, **Registry**, **Containers**, **Services**, and **Terminal**.

The container-related tabs serve different jobs:
- **Images** shows images already pulled or built for the room runtime.
- **Registry** shows room registry repositories and references so you can inspect refs, copy them, retag digests, or delete tags and untagged manifests.
