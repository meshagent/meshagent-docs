...
- manage project OAuth clients used for LLM proxy access
- manage project external OAuth registrations used by the LLM proxy
...
In the admin API and SDKs, project membership is controlled with four flags:
