---
title: "Multi-channel Agent Architecture"
---
...
- [Multi-channel Agents Overview](./overview): when to choose `process` and what problem it solves
- [Using Multi-channel Agents](./using_process): the practical CLI workflow
