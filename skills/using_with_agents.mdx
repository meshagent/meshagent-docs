...
Process-backed MeshAgent agents support skills. In practice, you usually load them with repeated `--skill-dir` flags and combine them with rules and tools.
...
The example below creates a small local skill and then starts a process-backed agent that can use it.
...
### Step 2: Start a process-backed agent with the skill
