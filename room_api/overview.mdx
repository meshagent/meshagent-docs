...
- **`ServicesClient` (Python/TypeScript/Dart):** List and restart services running in the room. For deployment patterns, see [Packaging and Deploying Services](../services/deployment/deploy_services).
