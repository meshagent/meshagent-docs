...
- **Localhost Networking**: Expose one or more ports to enable inter-service communication over  during development.
...
- [Local Development](./local_development): Learn how to build and test services on your machine using ServiceHost
- [Service Configuration](./service_configuration): Learn how to build and test services on your machine using ServiceHost
- [Deployment Options](./service_deployment): Explore project-wide vs room-specific deployment strategies
