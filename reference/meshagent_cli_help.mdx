...
* `--key TEXT`: an api key to sign the token with
* `-rr, --room-rules TEXT`: a path to a rules file within the room that can be used to customize the agent&#x27;s behavior
* `-st, --save-transcript-path TEXT`: Save voice conversation transcript as a MeshDocument at this path template. Template supports &#123;participant_name&#125;, &#123;participant_id&#125;, &#123;agent_name&#125;, &#123;date&#125;, &#123;time&#125;.
* `--help`: Show this message and exit.
...
* `--require-shell / --no-require-shell`: Enable function shell tool calling  [default: no-require-shell]
* `--require-local-shell / --no-require-local-shell`: Enable local shell tool calling  [default: no-require-local-shell]
* `--require-web-search / --no-require-web-search`: [default: no-require-web-search]
* `--require-apply-patch / --no-require-apply-patch`: Enable apply patch tool calling  [default: no-require-apply-patch]
* `--key TEXT`: an api key to sign the token with
...
* `--require-table-read TEXT`: Enable table read tools for a specific table
* `--require-table-write TEXT`: Enable table write tools for a specific table
* `--reply-all / --no-reply-all`: [default: no-reply-all]
* `--enable-attachments / --no-enable-attachments`: [default: no-enable-attachments]
* `--working-directory TEXT`: The default working directory for shell commands
* `--skill-dir TEXT`: an agent skills directory
* `--shell-image TEXT`: an image tag to use to run shell commands in
* `--help`: Show this message and exit.
...
* `--mcp / --no-mcp`: Enable mcp tool calling  [default: no-mcp]
* `--storage / --no-storage`: Enable storage toolkit  [default: no-storage]
* `--require-local-shell / --no-require-local-shell`: [default: no-require-local-shell]
* `--require-web-search / --no-require-web-search`: [default: no-require-web-search]
* `--require-apply-patch / --no-require-apply-patch`: Enable apply patch tool calling  [default: no-require-apply-patch]
* `--host TEXT`
* `--port INTEGER`
...
* `--toolkit-name TEXT`
* `-rr, --room-rules TEXT`
* `--require-storage / --no-require-storage`: [default: no-require-storage]
* `--require-read-only-storage / --no-require-read-only-storage`: [default: no-require-read-only-storage]
* `--database-namespace TEXT`
* `--require-table-read TEXT`
* `--require-table-write TEXT`
* `--title TEXT`: a display name for the agent
* `--description TEXT`: a description for the agent
* `--working-directory TEXT`: The default working directory for shell commands
* `--skill-dir TEXT`: an agent skills directory
...
### `meshagent container exec`

**Usage**:

```console
$ meshagent container exec [OPTIONS]
```
...
```console
$ meshagent database [OPTIONS] COMMAND [ARGS]...
```
...
### `meshagent database tables`

**Usage**:

```console
$ meshagent database tables [OPTIONS]
```
...
### `meshagent database inspect`

**Usage**:

```console
$ meshagent database inspect [OPTIONS]
```
...
```console
$ meshagent database install [OPTIONS]
```
...
```console
$ meshagent database create [OPTIONS]
```
...
### `meshagent database drop`

**Usage**:

```console
$ meshagent database drop [OPTIONS]
```
...
### `meshagent database add-columns`
...
```console
$ meshagent database add-columns [OPTIONS]
```
...
### `meshagent database drop-columns`

**Usage**:

```console
$ meshagent database drop-columns [OPTIONS]
```
...
### `meshagent database insert`

**Usage**:

```console
$ meshagent database insert [OPTIONS]
```
...
### `meshagent database merge`

**Usage**:

```console
$ meshagent database merge [OPTIONS]
```
...
### `meshagent database update`

**Usage**:

```console
$ meshagent database update [OPTIONS]
```
...
### `meshagent database delete`

**Usage**:

```console
$ meshagent database delete [OPTIONS]
```
...
### `meshagent database search`

**Usage**:

```console
$ meshagent database search [OPTIONS]
```
...
### `meshagent database optimize`

**Usage**:

```console
$ meshagent database optimize [OPTIONS]
```
...
### `meshagent database versions`

**Usage**:

```console
$ meshagent database versions [OPTIONS]
```
...
### `meshagent database checkout`

**Usage**:

```console
$ meshagent database checkout [OPTIONS]
```
...
* `--room TEXT`: Room name  [required]
* `-t, --table TEXT`: [required]
* `-v, --version INTEGER`: [required]
* `-n, --namespace TEXT`: Namespace path segments (repeatable). Example: -n prod -n analytics
* `--help`: Show this message and exit.

### `meshagent database restore`

**Usage**:

```console
$ meshagent database restore [OPTIONS]
```
...
### `meshagent database indexes`

**Usage**:

```console
$ meshagent database indexes [OPTIONS]
```
...
### `meshagent database index-create`

**Usage**:

```console
$ meshagent database index-create [OPTIONS]
```
...
* `--room TEXT`: Room name  [required]
* `-t, --table TEXT`: [required]
* `-c, --column TEXT`: [required]
* `--kind TEXT`: vector | scalar | fts  [default: scalar]
* `--replace / --no-replace`
* `-n, --namespace TEXT`: Namespace path segments (repeatable). Example: -n prod -n analytics
* `--help`: Show this message and exit.

### `meshagent database index-drop`

**Usage**:

```console
$ meshagent database index-drop [OPTIONS]
```
