...
For OpenAI compatible SDKs, you can also set `OPENAI_BASE_URL` to `https://api.meshagent.com/openai/v1` and pass the MeshAgent participant token as `api_key`. Room containers set `OPENAI_BASE_URL` and `ANTHROPIC_BASE_URL` automatically.
