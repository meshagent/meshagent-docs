...
Use `meshagent session list` to find recent sessions in the active project, then use `meshagent session get SESSION_ID` to inspect the recorded events for one specific run.
