...
* **[TaskRunner](./taskrunner)** – Wraps existing agents from any framework (Pydantic AI, LangChain, CrewAI, etc.) to work seamlessly with MeshAgent. Requires only input/output schemas and an ask() method—no refactoring of your agent logic needed. Instantly makes your agents discoverable in Studio and callable via API.
