...
| --- | --- | --- | --- | --- | --- |
| **Python** | [`meshagent`](https://pypi.org/project/meshagent/) (+ [`meshagent-livekit`](https://pypi.org/project/meshagent-livekit/)) | ✅ Full client (rooms, messaging, docs, storage, queues, tools) | ✅ Process-oriented CLI workflow, VoiceBot, room-connected agent building blocks, and legacy compatibility classes | ✅ Project/room/secret/token helpers via REST | — |
