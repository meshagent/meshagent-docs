...
If you need outbound header resolution for an MCP connection, `meshagent mcp http --header-secret ...` can resolve a room secret into an HTTP header. For a full example, see [Supabase MCP](../agents/tools/supabase_mcp).
