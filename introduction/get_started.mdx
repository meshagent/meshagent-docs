...
**Note**: Installing the entire MeshAgent SDK as shown above automatically installs the MeshAgent CLI package, but the CLI can also be installed independently using ``uv add meshagent-cli`` or ``pip3 install meshagent-cli``.
