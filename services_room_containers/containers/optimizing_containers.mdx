...
- If you are deploying a CLI process agent or VoiceBot, use the `meshagent/cli` base image. It is already optimized and supports the standard flags (tools, rules, room-rules, etc.), so you usually do not need to build a custom image.
