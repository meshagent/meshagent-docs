...
For full details on the service spec and deployment flow, see [Packaging and Deploying Services](../../services_room_containers/packaging_and_deploying/packaging). If you want to ship reusable private skills with the chatbot, see [Bundle Private Skills with a Custom Service](../../agent_skills/packaging_and_deploying).
...
- [Packaging and Deploying Services](../../services_room_containers/packaging_and_deploying/packaging): Package and deploy agents as room or project services.
