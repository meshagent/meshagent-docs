...
| **TypeScript / JavaScript** | `@meshagent/meshagent` | `@meshagent/meshagent-node-ts`, `@meshagent/meshagent-livekit`, `@meshagent/meshagent-react`, `@meshagent/meshagent-ts-auth`, `@meshagent/meshagent-react-auth` | Browser and Node apps, room clients, admin clients, local Node dev servers, LiveKit helpers, and React UI |
...
- Building a Node dev server that needs to expose the local room websocket proxy: add `@meshagent/meshagent-node-ts`.
