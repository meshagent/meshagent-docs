...
- A user clicks “Add Reserach Agent” → the Agent Manager launches a Research Agent room service via the MeshAgent Containers API in the user's room.
...
- [Configure project services](./project-services/configuration) when you’re ready to deploy across every room.
- [Configure room containers](./room-containers/configuration) to build reusable on-demand templates.
