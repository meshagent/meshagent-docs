...
| --- | --- | --- | --- |
| **Python** | `meshagent[all]` | `meshagent-api`, `meshagent-agents`, `meshagent-cli`, `meshagent-tools`, `meshagent-openai`, `meshagent-anthropic`, `meshagent-livekit`, `meshagent-telegram`, `meshagent-slack-channel`, `meshagent-twilio`, `meshagent-whatsapp`, `meshagent-mcp`, `meshagent-computers` | Full agent authoring, CLI workflows, room clients, process channels, and project admin |
