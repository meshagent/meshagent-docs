...
A ``ServiceTemplate`` manifest defines what inputs a container accepts and how they map to environment variables. See the [configure room services](../services_room_containers/room_services/configuration) documentation for more details. 
...
- [Configure room services through containers API](../services_room_containers/room_services/configuration)
