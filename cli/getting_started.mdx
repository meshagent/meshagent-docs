...
2. **Install the MeshAgent CLI**: You can install the CLI globally on your system or in a virtual environment. 
    **To install the CLI globally:**
    ...
    # Alternatively:
    Invoke-WebRequest -Uri "https://storage.googleapis.com/meshagent-cli-builds/0.26.0/meshagent.0.26.0.nupkg" -OutFile "C:\Downloads\meshagent.0.26.0.nupkg"
    choco install meshagent --source "C:\Downloads\meshagent.0.26.0.nupkg"
    ```
    ```bash Other
