...
2. **Install the MeshAgent CLI**: You can install the CLI globally on your system or in a virtual environment. 
    **To install the CLI globally:**
    ...
    # Alternatively:
    Invoke-WebRequest -Uri "https://storage.googleapis.com/meshagent-cli-builds/0.24.2/meshagent.0.24.2.nupkg" -OutFile "C:\Downloads\meshagent.0.24.2.nupkg"
    choco install meshagent --source "C:\Downloads\meshagent.0.24.2.nupkg"
    ```
    ```bash Other
...
Once your agent works locally, you'll need to [package](../services_room_containers/packaging) and [deploy](../services_room_containers/deployment) it as a project or room service. You can do this from MeshAgent Studio or using the CLI.
...
When deploying a custom agent, you will need to build and push a docker image. For an example of this, check out [Deploying a Custom ChatBot](../services_room_containers/deployment#example-deploy-a-custom-chatbot) to see how to build and deploy a chat agent as a project or room service.
...
- [Introduction to Services](../services_room_containers/packaging): Understand project and room services and how to run ad-hoc code in a Room through the Containers API
- [Packaging Services](../services_room_containers/packaging): Learn about meshagent.yaml configuration
- [Deploying Services](../services_room_containers/deployment): Learn how to deploy project and room services
