...
- A combined room/project deployment walkthrough in [Deploying Services](./deployment#example-deploy-a-custom-chatbot)
...
- [Deployment example](./deployment#example-deploy-a-custom-chatbot): Deploy a chatbot as a project or room service.
