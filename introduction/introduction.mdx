...
- Invite teammates to collaborate live from [MeshAgent Studio](../interfaces/meshagent_studio), Powerboards, or your own application
...
- an in-room [LLM proxy](../agents/adapters/llm_proxy) that secures API keys and provides automatic cost attribution and controls
