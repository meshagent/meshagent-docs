...
ChatBots can be extended with rules, tools, and skills depending on the kind of help you want them to provide. See [Tools Overview](../tools/intro) and [Skills Overview](../../agent_skills/overview).
