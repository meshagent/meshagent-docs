...
## Related Topics
- [Packaging services](../packaging): Field reference and examples for packaging a service.
- [Deploying services](../deployment): Ship and update services from the CLI or Studio.
- [Deployment example](../deployment#example-deploy-a-custom-chatbot): Deploy a service as a project or room service.
