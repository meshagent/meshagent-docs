...
**Phase Overview**
1. **[Using the MeshAgent CLI](#phase-1-chat-with-the-built-in-chatbot-from-the-cli)**: Bring a ready-made ChatBot into a room using a single CLI command.
2. **[Basic ChatBot](#phase-2-building-a-simple-chatbot)**: Create a simple agent with a system prompt (rules) and connect it to a MeshAgent room. This allows us to see the code behind the CLI chatbot. 
...
4. **[ChatBot with Built-in MeshAgent Tools and Custom Tools](#phase-4-adding-custom-tools-to-our-chatbot)**: Add additional custom tools to the agent for use-case specific tasks. 
