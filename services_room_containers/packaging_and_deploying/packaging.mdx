...
- [Deploy a customizable multi-agent service](./packaging_and_deploying/multi_image_service) — Deploy a chatbot and mailbot where users can create their own email. 
- [Deploy a terminal based agent](./packaging_and_deploying/terminal_based_agents) - Deploy a terminal based agent like Codex into a Room. 
