...
2. Create a new project from the MeshAgent Studio UI or MeshAgent CLI ``meshagent project create my-new-project``
...
- [Build and Deploy a Chat Agent](../agents/standard/buildanddeploychatbot): Full tutorial to build and deploy a chat agent with tools
- [Build and Deploy a Voice Agent](../agents/standard/buildanddeployvoicebot): Full tutorial to build and deploy a voice agent with tools