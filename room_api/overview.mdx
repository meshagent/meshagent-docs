...
Next, in your terminal export the environment variables needed to connect to your MeshAgent project. You can do this using the MeshAgent CLI.
...
# select the shell you're using bash | zsh | fish | powershell | cmd
meshagent env --shell bash
```
</CodeGroup>
