...
A ``ServiceTemplate`` manifest defines what inputs a container accepts and how they map to environment variables. See the [packaging services](../services_room_containers/packaging) documentation for more details. 
