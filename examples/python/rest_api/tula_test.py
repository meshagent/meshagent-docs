...
async def main():
    ...
    project_id = "1fd090a4-8dc5-4918-948b-2b1b2c981eb0"
    client = Meshagent(base_url="https://api.meshagent.life", token=access_token)
    try:
        role = await client.get_project_status(project_id)
        print("Result:", role)
    except Exception as e:
        print("Exception:", e)
    try:
        rooms = await client.list_rooms(project_id, view="my")
        print("My rooms:", rooms)
    finally:
        await client.close()
