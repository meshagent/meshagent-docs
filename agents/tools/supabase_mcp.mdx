...
- Deploy the Supabase MCP server as a MeshAgent service. This will allow you to use the Supabase MCP Server as a MeshAgent toolkit. (Multiple people in your room can use the same one.)
