...
<CodeGroup>
```bash bash
meshagent chatbot join --room my-room --agent-name "Chat Agent"
```
</CodeGroup>

<CodeGroup>
```bash bash
meshagent voicebot join --room my-room --agent-name "Voice Agent"
```
</CodeGroup>
...
<CodeGroup>
```bash bash
meshagent chatbot service --agent-name=test --room my-room
```
</CodeGroup>
