...
MailBots can be extended with rules, tools, and skills depending on the workflow they need to handle. See [Tools Overview](../tools/intro) and [Skills Overview](../../agent_skills/overview).
