...
For the full service YAML reference, see [Deploy Services with MeshAgent](../services_room_containers/packaging_and_deploying/packaging#how-service-configuration-files-are-structured).
...
- [Deploy Services with MeshAgent](../services_room_containers/packaging_and_deploying/packaging#service-configuration-field-reference): full service YAML field reference.
