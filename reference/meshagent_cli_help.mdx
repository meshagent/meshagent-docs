...
* `agent`: Interact with agents and toolkits in a room
* `agents`: Interact with agents and toolkits in a room
* `secret`: Manage room-scoped secrets and OAuth flows
* `secrets`: Manage room-scoped secrets and OAuth flows
...
* `services`: Manage services inside a room
...
```console
$ meshagent room agent call [OPTIONS] COMMAND [ARGS]...
```
...
##### `meshagent room agent call tool`
...
```console
$ meshagent room agent call tool [OPTIONS]
```
...
##### `meshagent room agent call agent`
...
```console
$ meshagent room agent call agent [OPTIONS]
```
...
##### `meshagent room agent call toolkit`
...
```console
$ meshagent room agent call toolkit [OPTIONS]
```
...
##### `meshagent room agent call schema`
...
```console
$ meshagent room agent call schema [OPTIONS]
```
...
```console
$ meshagent room secrets exists [OPTIONS]
```
...
#### `meshagent room database branch`
...
```console
$ meshagent room database branch [OPTIONS] COMMAND [ARGS]...
```
...
##### `meshagent room database branch list`
...
```console
$ meshagent room database branch list [OPTIONS]
```
...
##### `meshagent room database branch create`
...
```console
$ meshagent room database branch create [OPTIONS]
```
...
##### `meshagent room database branch delete`
...
```console
$ meshagent room database branch delete [OPTIONS]
```
...
##### `meshagent room container images inspect`
...
```console
$ meshagent room container images inspect [OPTIONS]
```
