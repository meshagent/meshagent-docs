...
| `add_user_to_project(project_id, user_id, …)`                            | `POST /accounts/projects/{project_id}/users`                     | Add a user with project membership flags such as admin, developer, room creation, agent creation, and LLM proxy use. |
