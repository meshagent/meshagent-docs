...
- **Built-in infrastructure**: Storage, dataset, queues, sync/documents, containers, secrets, messaging, and developer events are already part of the room runtime.
...
- **[Rooms](../room_api/overview)** with built-in runtime APIs for messaging, storage, dataset, queues, documents, containers, secrets, and developer events
