...
TaskRunners can be extended with rules, tools, and skills depending on how much reusable workflow guidance they need. See [Tools Overview](../tools/intro) and [Skills Overview](../../skills/overview).
...
For full details on the service spec and deployment flow, see [Packaging and Deploying Services](../../services_room_containers/packaging_and_deploying/packaging). If you want to ship TaskRunner skills with the service, see [Packaging and Deploying Skills](../../skills/packaging_and_deploying).
...
- [Skills Overview](../../skills/overview) for reusable workflows that complement schemas and tools
