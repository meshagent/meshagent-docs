...
A ``ServiceTemplate`` manifest defines what inputs a container accepts and how they map to environment variables. See the [configure room services](../services_room_containers/room_containers/configuration) documentation for more details. 
