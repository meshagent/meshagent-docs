...
class ProductWidget(Tool):
    def __init__(self):
        super().__init__(name="products", input_schema={
            "type" : "object",
...
class ProductToolkit(Toolkit):
    def __init__(self, thread: MeshDocument):
        super().__init__(
            name="products",
            tools=[
                InsertProductListingTool(thread)
            ]
        )
...
class UIChatBot(ChatBot):
    def __init__(self):
        super().__init__(
            ...
            rules=[
                "use the insert_product_listing tool to display a list of products"
            ]
        )
