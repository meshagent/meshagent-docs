...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.
* `--room TEXT`: Room name
* `--tag TEXT`: Image tag to deploy, e.g. repo/name:tag. When used with --pack, shorthand &lt;repository&gt;:&lt;tag&gt; and &lt;project-key&gt;/&lt;repository&gt;:&lt;tag&gt; resolve against the configured MeshAgent registry.  [required]
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.
* `--room TEXT`: Room name
* `--tag TEXT`: Image reference to publish. Supports &lt;repository&gt;:&lt;tag&gt;, &lt;project-key&gt;/&lt;repository&gt;:&lt;tag&gt;, or &lt;registry&gt;/&lt;project-key&gt;/&lt;repository&gt;:&lt;tag&gt;. Shorthand forms resolve against the configured MeshAgent registry.  [required]
