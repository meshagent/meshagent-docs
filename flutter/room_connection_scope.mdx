...
RoomConnectionScope(
  authorization: (context) async {
    ...
    final jwt = await fetchJwtToken();

    return RoomConnectionInfo(
      url: 'wss://your-meshagent-url',
      jwt: jwt,
    );
  },
