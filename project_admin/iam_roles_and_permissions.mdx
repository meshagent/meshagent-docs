...
| `participant_token_creator` | Participant token impersonation | Allow a service account to request a participant token for another user. The target user's room or agent permissions still apply. |
