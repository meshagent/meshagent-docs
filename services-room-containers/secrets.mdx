...
A ``ServiceTemplate`` manifest defines what inputs a container accepts and how they map to environment variables. See the [configure room services](./room-containers/configuration) documentation for more details. 
...
- [Configure room services through containers API](./room-containers/configuration)
