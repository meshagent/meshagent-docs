...
Combine these snippets with the `api` field when [packaging a service](../services_room_containers/packaging_and_deploying/packaging) to set the appropriate permissions for your service.
