...
Workers can also be extended with rules, tools, and skills for repeatable background workflows. See [Tools Overview](../tools/intro) and [Skills Overview](../../agent_skills/overview).
