...
**Add authentication** — If your MCP server requires OAuth, add an `oauth` configuration to the `mcp` endpoint. See the [`oauth` fields](./packaging#ports-endpoints) in the field reference.
