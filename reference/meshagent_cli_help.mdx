...
* `claude-code`: Launch Claude Code through MeshAgent for...
...
## `meshagent claude-code`

Launch Claude Code through MeshAgent for the active project.

**Usage**:

```console
$ meshagent claude-code [OPTIONS]
```

**Options**:

* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.
* `--api-url TEXT`: Override the MeshAgent API URL for this Claude Code launch.
* `--help`: Show this message and exit.
