...
MeshAgent tools can be run either independently or within an agent. Tools are centrally managed like agents meaning they can be deployed as a MeshAgent service and used by people or agents that have access to your Room. Toolkits allow you to group related Tools together so that they can be used seamlessly by the agent. 
...
### Connecting custom tools to a MeshAgent Room
