...
- work with room storage, dataset tables, memory, and custom toolkits
...
| [Project Service](../../services/deployment/deploy_services) | Deploy once to run automatically in every room of a project. | Shared always-on agents |
| [Room Service](../../services/deployment/deploy_services) | Deploy to a specific room only. | Room-scoped agents |
...
- [VoiceBot](../standard/voicebot): Learn the current dedicated voice runtime.
