...
If you want the same daily news workflow built as **one process agent with multiple channels** instead of several coordinated agents, compare this example with [Deploy a Process Agent Service](./process_agent_service).
