...
- `ApiScope.agent_default()` enables Livekit, Queues, Messaging, Database, Memory, Sync, Storage, Containers, Developer, Agents, LLM, Services, and Secrets access.
- `ApiScope.full()` adds Admin and Tunnels access on top of `agent_default()`.
