---
title: "Multi-channel Agents Overview"
---
...
For the full implementation model, see [Multi-channel Agent Architecture](./architecture). For the thread model those runtime pieces write into, see [Threads Overview](../threads_overview).

## Where to go next

- [Using Multi-channel Agents](./using_process): the practical CLI path, starting with a small runnable example
- [Multi-channel Agent Architecture](./architecture): the implementation model for engineers extending or debugging the runtime
- [Threads Overview](../threads_overview): how thread paths control continuity and isolation
- [Deploy a Multi-channel Agent](../../services_room_containers/packaging_and_deploying/process_agent_service): package and deploy one multi-channel agent service
