...
- An embedding provider (default requires the OpenAI Python SDK and `OPENAI_API_KEY`, this will be provisioned automatically when deployed).
...
> **Note**: If running this locally you will need to export an ``OPENAI_API_KEY``. When deployed and running in the room that will be set automatically. 
