...
* `--room TEXT`: Room name. If empty, the MESHAGENT_ROOM environment variable will be used.  [required]
* `--name TEXT`
* `--image TEXT`
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.
* `-o, --output TEXT`: File path to a service definition
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
* `-i, --input TEXT`: File path to a service definition  [required]
* `--help`: Show this message and exit.
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.
* `--room TEXT`: Room name. If empty, the MESHAGENT_ROOM environment variable will be used.
* `--token-path TEXT`
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
...
* `run`: Create a service attached to the project.
...
* `build`: Build images
* `builds`: Inspect or manage running builds
...
### `meshagent container run-attached`

**Usage**:

```console
$ meshagent container run-attached [OPTIONS]
```
...
* `-e, --env TEXT`: KEY=VALUE
* `-p, --port TEXT`: CONTAINER:HOST
* `--send TEXT`: Optional lines to send to container stdin (each becomes a line)
* `--name TEXT`: [default: cli]
* `--role TEXT`: [default: user]
* `--help`: Show this message and exit.
...
```console
$ meshagent container build [OPTIONS] COMMAND [ARGS]...
```
...
#### `meshagent container build git`

**Usage**:

```console
$ meshagent container build git [OPTIONS]
```
...
* `--room TEXT`: Room name. If empty, the MESHAGENT_ROOM environment variable will be used.
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
* `--tag TEXT`: Resulting image tag  [required]
* `--url TEXT`: Git URL  [required]
* `--ref TEXT`: Git ref/branch/tag  [required]
* `--cred TEXT`: Docker creds (username,password) or (registry,username,password)
* `--name TEXT`: [default: cli]
* `--role TEXT`: [default: user]
...
#### `meshagent container build context`

**Usage**:

```console
$ meshagent container build context [OPTIONS]
```
...
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
* `--tag TEXT`: Resulting image tag  [required]
* `--from-dir TEXT`: Directory to tar.gz as build context
* `--dockerfile TEXT`: Path to a Dockerfile; sends just this file as context
* `--dockerfile-inline TEXT`: Inline Dockerfile text; sends only this as context
* `--tgz TEXT`: Use an existing .tar.gz file as the context
* `--cred TEXT`: Docker creds (username,password) or (registry,username,password)
* `--name TEXT`: [default: cli]
* `--role TEXT`: [default: user]
* `--pretty / --no-pretty`: [default: pretty]
...
#### `meshagent container build room`

**Usage**:

```console
$ meshagent container build room [OPTIONS]
```
...
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
* `--tag TEXT`: Resulting image tag  [required]
* `--path TEXT`: Room path to a .tar.gz context  [required]
* `--cred TEXT`: Docker creds (username,password) or (registry,username,password)
* `--name TEXT`: [default: cli]
* `--role TEXT`: [default: user]
* `--pretty / --no-pretty`: [default: pretty]
...
### `meshagent container builds`

Inspect or manage running builds

**Usage**:

```console
$ meshagent container builds [OPTIONS] COMMAND [ARGS]...
```
...
#### `meshagent container builds list`

**Usage**:

```console
$ meshagent container builds list [OPTIONS]
```
...
#### `meshagent container builds stop`

**Usage**:

```console
$ meshagent container builds stop [OPTIONS]
```
...
* `--room TEXT`: Room name. If empty, the MESHAGENT_ROOM environment variable will be used.
* `--api-key-id TEXT`: A MeshAgent project API key id. If empty, the activated api key will be used.
* `--request-id TEXT`: Build request_id to stop  [required]
* `--name TEXT`: [default: cli]
* `--role TEXT`: [default: user]
* `--help`: Show this message and exit.
