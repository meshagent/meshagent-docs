...
The adapter includes several builders and tools for OpenAI native tools. Agents can use them directly, or override them with agent-specific wrappers that add persistence and room-specific behavior.
...
- [Process Agents Overview](../process/overview): Shows where the adapter is invoked in the recommended overall agent flow.
