...
MeshAgent also exposes a room-scoped registry surface for published image repositories and tags. This is the same registry view used by MeshAgent Studio's **Registry** tab.
