...
metadata:
  ...
  description: An agent that uses Anthropic's marketing knowledge work plugin and powered by Claude Sonnet 4.5
  annotations:
    meshagent.service.id: meshagent.claude-marketing
...
container:
  ...
  storage:
    ...
    - path: /var/start.sh
      text: |
          ...
          exec /usr/bin/meshagent process join \
            ...
            --require-storage \
            --require-web-search \
            --rule="when the user requests help with competitive analysis, content creation, brand voice, campaign planning, or performance analytics you MUST read and follow the corresponding skill from /data/knowledge-work-plugins/skills" \
            ...
            --rules-file /data/knowledge-work-plugins/commands/brand-review.md \
            --rules-file /data/knowledge-work-plugins/commands/campaign-plan.md \
            --rules-file /data/knowledge-work-plugins/commands/competitive-brief.md \
            --rules-file /data/knowledge-work-plugins/commands/draft-content.md \
            --rules-file /data/knowledge-work-plugins/commands/email-sequence.md \
            --rules-file /data/knowledge-work-plugins/commands/performance-report.md \
            --rules-file /data/knowledge-work-plugins/commands/seo-audit.md \
            --skill-dir /data/knowledge-work-plugins/skills/brand-voice \
            --skill-dir /data/knowledge-work-plugins/skills/campaign-planning \
            --skill-dir /data/knowledge-work-plugins/skills/competitive-analysis \
            --skill-dir /data/knowledge-work-plugins/skills/content-creation \
            --skill-dir /data/knowledge-work-plugins/skills/performance-analytics
    - path: /knowledge-work-plugins/commands/brand-review.md
      text: |
          ---
    ...
    - path: /knowledge-work-plugins/commands/campaign-plan.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/commands/draft-content.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/commands/email-sequence.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/commands/performance-report.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/commands/seo-audit.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/skills/brand-voice/SKILL.md
      text: |
        ---
        name: brand-voice
    ...
    - path: /knowledge-work-plugins/skills/campaign-planning/SKILL.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/skills/content-creation/SKILL.md
      text: |
        ---
    ...
    - path: /knowledge-work-plugins/skills/performance-analytics/SKILL.md
      text: |
        ---
