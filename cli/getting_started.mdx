...
Once your agent works locally, you'll need to [package and deploy](../services_room_containers/packaging) it as a project or room service. You can do this from MeshAgent Studio or using the CLI.
...
When deploying a custom agent, you will need to build and push a docker image. For an example of this, check out [Packaging and Deploying Services](../services_room_containers/packaging#example-deploy-a-custom-chatbot) to see how to build and deploy a chat agent as a project or room service.
...
- [Packaging and Deploying Services](../services_room_containers/packaging): Learn about meshagent.yaml configuration
- [Packaging and Deploying Services](../services_room_containers/packaging): Learn how to deploy project and room services
