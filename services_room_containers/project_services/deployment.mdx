...
- Check out [running a room service](../room_containers/running) to learn how to run a service in a specific room with the containers API. 
- Learn how to create and use secrets with MeshAgent in [Secrets & Registry Access](../secrets/secrets_overview).
