...
| **TypeScript / JavaScript** | `@meshagent/meshagent` | `@meshagent/meshagent-react`, `@meshagent/meshagent-react-auth` | Browser and Node apps, room clients, admin clients, and React UI |
...
- Building a React app that needs OAuth login: add `@meshagent/meshagent-react-auth`; it does not require a React Query provider.
