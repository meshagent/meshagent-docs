...
If you want the same daily news workflow built as **one multi-channel agent** instead of several coordinated agents, compare this example with [Deploy a Multi-channel Agent](./process_agent_service).
