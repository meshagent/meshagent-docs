...
## Deployment Options
- **MeshAgent CLI**: Automate deployments and integrate with CI/CD workflows. The CLI expects a `kind: Service` YAML file. If you start from a `ServiceTemplate`, replace variables with concrete values before deploying. 
