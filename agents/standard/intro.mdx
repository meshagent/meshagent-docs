...
| [List Toolkits](../../room_api/agents#2-list-toolkits) | Retrieves all toolkits (and their tools) available in the room. |
| [Invoke Tool](../../room_api/agents#3-invoke-tool) | Directly executes a specific tool within a toolkit without routing through an agent. |
