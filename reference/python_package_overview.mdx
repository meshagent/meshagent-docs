...
MeshAgent’s [Key Concepts](../introduction/introduction) page explains what agents, tools, rooms, and services are. This guide shows how those ideas are implemented in the MeshAgent SDK.
