...
1) **Set up a Python environment** and install the SDK  and python-dotenv
2) **Use the CLI to create and activate an API key**, then store it in `.env`  
...
# Create a virtual environment with python 3.13 (required for MeshAgent)
uv venv --python 3.13 
...
uv pip install "meshagent[all]" python-dotenv
```
