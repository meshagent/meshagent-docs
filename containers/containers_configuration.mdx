...
Containers are configured using the ``ContainerSpec`` which defines how your service should run within a room. Unlike project-wide services, containers are deployed on-demand and can be customized per deployment. 
