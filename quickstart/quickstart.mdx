import QuickstartDocumentPy from "/snippets/python/quickstart-document.mdx";
import QuickstartDocumentJs from "/snippets/javascript/quickstart-document.mdx";
import QuickstartDocumentTs from "/snippets/typescript/quickstart-document.mdx";
import QuickstartDocumentDart from "/snippets/dart/quickstart-document.mdx";

import QuickstartAgentPy from "/snippets/python/quickstart-agent.mdx";
import QuickstartAgentJs from "/snippets/javascript/quickstart-agent.mdx";
import QuickstartAgentTs from "/snippets/typescript/quickstart-agent.mdx";
import QuickstartAgentDart from "/snippets/dart/quickstart-agent.mdx";
