...
* `mesh`: connect agents and tools to a room for...
...
```console
$ meshagent mesh [OPTIONS] COMMAND [ARGS]...
```
...
### `meshagent mesh service`

**Usage**:

```console
$ meshagent mesh service [OPTIONS]
```
