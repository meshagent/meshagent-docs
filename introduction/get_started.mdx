...
Before you start, make sure your machine matches the appropriate requirements. If you’ve *never* set up Python, pip, or uv before, follow the [**Machine Setup Guide**](./machine_setup.mdx) first, then return here.
