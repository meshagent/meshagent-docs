...
Use this page when you want to add your own spans, logs, and metrics inside a custom Python service.
...
Package the sample with a `meshagent.yaml` file and a container image that MeshAgent can run. For the general deployment flow, see [Deploy Services with MeshAgent](../services/deployment/deploy_services).
...
- [Deploy Services with MeshAgent](../services/deployment/deploy_services): deploy instrumented agents and tools as room or project services
