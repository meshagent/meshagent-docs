...
3. Next, click the link to install an agent that uses the toolkit: [Install Agent that Uses Supabase Toolkit in Powerboards](https://app.powerboards.com/install?url=).
