...
- **Fully Custom Tools**: Write your own tools however you want and register them with MeshAgent
- **MCP Tools**: Integrate existing MCP servers as MeshAgent tools
- **Agents as Tools**: Use a TaskRunner and pass this as a tool to your Chat or Voice Agent
