...
For full details on the service spec and deployment flow, see [Service YAML](../../services/deployment/deploy_services). If you want to bundle reusable private skills with the worker, see [Bundle Private Skills with a Custom Service](../../agent_skills/packaging_and_deploying).
