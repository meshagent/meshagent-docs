...
- **Container-backed:** MeshAgent runs your image in the room
...
- [Packaging services](./packaging_and_deploying/packaging) and [Deploying Services](./packaging_and_deploying/deployment) when you’re ready to deploy across every room.