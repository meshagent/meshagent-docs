...
Workers can also be extended with rules, tools, and skills for repeatable background workflows. See [Tools Overview](../tools/intro) and [Skills Overview](../../skills/overview).
...
For full details on the service spec and deployment flow, see [Packaging and Deploying Services](../../services_room_containers/packaging_and_deploying/packaging). If you want to bundle reusable skills with the worker, see [Packaging and Deploying Skills](../../skills/packaging_and_deploying).
...
- [Skills Overview](../../skills/overview) for reusable workflow guidance shared across agent runs
